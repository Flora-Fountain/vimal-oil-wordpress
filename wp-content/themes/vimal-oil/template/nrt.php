...
?>
    ...
    <div class="inner-banner default-section nrt-banner">
        <div class="container">
            <div class="text-middle">
                <div class="nrt-logo-img">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/NRT-logo.png" alt="nrt-logo">
                </div>
                <div class="banner-right">
                    <div class="h1-title">
                        <h1 class="text-noeffect">Know about Nutrition <br/>Retention Technology</h1>
                    </div>
                </div>
        ...
        <div class="nrt-ani">
            <div class="oil-spread">
                ...
                <div class="oil-swirl" style="height:0px;" id="oil-swirl">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/oil-spread.png" sizes="100vw" alt="oil.png" class="coffee-swirl-image" id="oil-swirl" />
                </div>
            </div>
