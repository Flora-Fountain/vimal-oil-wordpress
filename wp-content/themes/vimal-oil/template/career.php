                ...
                <div class="job-card">
                    ...
                    <div class="role-small-details">
                        ...
                        <div class="view-button">
                            <a href="#">View Job
                                <span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -6.5 36 36">
                                    <g fill-rule="evenodd">
                                        <g id="ui-gambling-website-lined-icnos-casinoshunter" fill-rule="nonzero" transform="translate(-212.000000, -159.000000)">
        ...
        <div class="container">
            <div class="career-form">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            <input type="tel" class="form-control" name="name" placeholder="Contact no." required="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group state-select">
                            <select name="State" id="state" class="form-control">
                                <option value="ahmedabad">Select role</option>
                                <option value="rajkot">Rajkot</option>
                                <option value="surat">Surat</option>
                            </select>
                        </div>
