...
<div class="hero-banner video-banner blue-bg-banner recipes-sec">
        ...
        <div class="text-middle">
            <div class="banner-right">
                <div class="h1-title">
                    <h1 class="text-noeffect">Explore our <br/>recipes</h1>
                </div>
            </div>
            <div class="max-para">
                <p>simply dummy text of the printing and typesetting industry. Lorem simply dummy text of the printing and typesetting industry. Lorem</p>
            </div>
            <div class="submit-button text-center">
                <button class="btn-effect" type="submit">See More</button>
            </div>
        </div>
</div>
